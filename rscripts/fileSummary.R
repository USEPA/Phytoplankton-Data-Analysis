...
write.table( OUT, "output/reducedFileSurvey.0610.csv", sep = ",", row.names=FALSE)
write.table( INFO, "output/reducedFileList.0610.csv", sep = ",", row.names=FALSE)
write.table( INFOorig, "output/fullFileList.0610.csv", sep = ",", row.names=FALSE)
