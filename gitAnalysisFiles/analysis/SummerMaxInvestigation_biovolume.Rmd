---
title: "Summer Max Investigation - Total Biovolume"
author: "Megan Higgs"
...
library(lubridate)
library(openxlsx)
#setwd("~/repos/EPA TO57/analysis")  #Set your working directory
```

Here is a look at using the maximum summer (June - Sept) blue-green algae total biovolume as the response for each year compared to other counts.  
